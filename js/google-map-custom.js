...
//*********************Google MAP *********************/
		...
		var saturation = 100 // 
		var mapLatitude=-33.521166
		var mapLongitude=-70.593762//(Fist Value Latitude, Second Value ), get YOUR coordenates here!: http://itouchmap.com/latlong.html
		var mapZoom_value=16 // Map zoom level parameter only numeric  


// Google map marker example 2 locations 
		//map-marker #1
		var marker1_Latitude=-33.521652
		var marker1_Longitude=-70.595795
		var marker1_content="<h2>UPTIVA</h2> Bridge Water, NJ" // marker or  on click content (Info Window) 
		var marker1_pointerUrl = 'assets/img/map-marker.png' // set your color pointer here!

		//map-marker #2
		var marker2_Latitude=-33.521652
		var marker2_Longitude=-70.595795
		var marker2_content="<h2>UPTIVA</h2>San Diego California" // marker or  on click content (Info Window) 
